...
public class IsynetMSQLConnector {
    ...
    public void createPatient(BundleStructure bundleStructure, int IDValue) {
        IDValue = 9;
        try {
...
//                  "SET IDENTITY_INSERT [dbo].[Patient] OFF\n" +
                    ...
                    "VALUES(" + IDvalue + ",0,'" + bundleStructure.getPatient().getLastName() + ", " + bundleStructure.getPatient().getFirstName() + " (" + IDvalue + ")','Anmeldung',{d '" + timestamp1 + "'},0,3000,'Neuer Patient erfasst.',1,1,{t '" + timestamp3 + "'})\n" +
                    ...
                    "VALUES({ts '1899-12-30 " + timestamp3 + "'}, " + IDvalue + ",4000,{d '" + timestamp1 + "'},'KKEIN','',0,0,0,'<KKData BEHANDLER=\"\"></KKData>',0,0,{ts '" + timestamp1 + " " + timestamp3 + "'},1,1,{d '" + timestamp1 + "'},1,1)\n" +
